...
export const generateOrderPDF = (order: any) => {
  ...
  // Fundo do card
  doc.setFillColor(
    lightGrayColor[0] * 255,
    lightGrayColor[1] * 255,
    lightGrayColor[2] * 255
  );
  ...
  doc.text("Wibbo - Sistema de Catálogo SaaS", 20, pageHeight - 15);
  doc.text("www.wibbo.com", 20, pageHeight - 10);
